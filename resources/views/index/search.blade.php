          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              <ul class="aa-product-catg">
                ...
                <li>
                  <figure>
                    <a class="aa-product-img" href="{{URL::to('/chi-tiet-san-pham/'.$product->id)}}"><img src="/uploads/products/{{$product->image}}" alt="polo shirt img" style="width: 250px;height: 250px"></a>
                    <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Mua ngay</a>
                    <figcaption>
                      <h4 class="aa-product-title"><a href="#">{{$product->name}}</a></h4>
                      <span class="aa-product-price">{{ number_format($product->price,0)}}<sup>đ</sup></span>
                    </figcaption>
                  </figure>                         
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-recently-views">
                <ul>
                   ...
                   <li>
                    <a href="{{URL::to('/chi-tiet-san-pham/'.$product->id)}}" class="aa-cartbox-img"><img src="/uploads/products/{{$product->image}}" alt="polo shirt img" style="width: 100px;height: 100px"></a>
                    <div class="aa-cartbox-info">
                      <h4><a href="#">{{$product->name}}</a></h4>
